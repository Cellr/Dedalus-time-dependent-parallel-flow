...
problem = d3.IVP([laplacian_psi_prime,laplacian_laplacian_psi_prime,psi_prime], namespace=locals())
...
problem.add_equation("d3.TimeDerivative(laplacian_psi_prime)- nv * laplacian_laplacian_psi_prime+ beta * d3.Differentiate(psi_prime, coords['x'])=-jacobian(psi_prime, laplacian_psi_bar) -jacobian(psi_bar, laplacian_psi_prime)-jacobian(psi_prime, laplacian_psi_prime)")
